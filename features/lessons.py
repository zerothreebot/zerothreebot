...
sql=fetch('lessons_additional',rows='lesson_id, lesson_name, chat_link, lesson_link, lesson_link_add, classroom_link', order_by='lesson_id')
lessons_additional={}
for i in sql:
    ...
    lessons_additional[i[0]]['lesson_link_add']=i[4]
    lessons_additional[i[0]]['classroom_link']=i[5]
